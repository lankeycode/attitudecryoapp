	...
	return (
		<div className=" font-taviraj bg-blue3 animate__animated animate__fadeIn animate__slower ">
			<Head>
				...
				<meta
					name="description"
					content="Le centre Attitude Cryo situé à Grenoble. "
				/>
			</Head>
			...
			<Layout>
				...
				<div className="relative xs:-top-48 sm:-top-60 w-[90vw] md:w-[70vw]  mx-auto  h-[50vh] md:h-[60vh] mdl:h-[70vh] border-2 border-black">
					<Image src="/attitudeLogo.svg" layout="fill" alt="" />
				</div>
				<div className="min-h-screen bg-blue1 border-t-4 border-t-skyblue relative w-screen  pb-40 pt-40 mb-80 mdl:mb-[55rem] text-lg top-10   ">
					...
					<div ref={ref2}>
						...
						>
							...
							d’Aurore Concept, une double chambre (-60°c et -110°C)
							de cryothérapie en corps entier électrique et
							intelligente dotée d’une caméra infrathermique, pouvant
							accueillir jusqu’à 2 personnes sur la même séance.
						</motion.p>
					</div>
					<div ref={ref5}>
						<motion.p
					...
					<div ref={ref3}>
						...
						>
							...
							(infrarouges longs),une technologie brevetée,
							fabrication à la main 100% française, bienfaits prouvés
							cliniquement.
						</motion.p>
					</div>
					...
					<div ref={ref4}>
						...
						>
							...
							<br />
							Une toute nouvelle innovation la « Stimulation
				...
				<div className={Styles.section5}>
					<p className={Styles.p7}>
						Venez découvrir tous les bienfaits au sein de notre
						centre.
					</p>
					<br />
				</div>
