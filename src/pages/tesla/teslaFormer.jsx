		...
		<div className="min-h-screen bg-blue1  font-taviraj animate__animated animate__fadeIn animate__slow">
			...
			<Layout>
				...
				<div className="relative  text-center text-xl  ">
					<div className="section1 relative w-screen block mdl:flex  ">
						<div className="relative mdl:w-[55vw] mdl:h-[70vh] mdl:top-[5rem] mdl:ml-[5rem]  shadow-lg shadow-blue mdl:border-2 border-l-blue mdl:border-t-blue  ">
							<Image
				...
				<div className="relative left-1/2 -translate-x-1/2 xs:w-[90vw] md:w-[80vw] mdl:w-[70vw] xs:h-[25vh] md:h-[30vh] mdl:h-[60vh] mb-20 md:border-4 border-blue ">
					<Image src="/zonesTesla1.png" layout="fill" alt="#" />
				</div>
				<p className="mt-5 text-center text-xl text-blue font-bold">
				...
				<div className="relative left-1/2 -translate-x-1/2 xs:w-[90vw] md:w-[80vw] mdl:w-[70vw] xs:h-[25vh] md:h-[30vh] mdl:h-[60vh] mb-20 md:border-4 border-blue ">
					<Image src="/zonesChair.png" layout="fill" alt="#" />
				</div>
				{/**************************************** */}
