			...
			<Layout>
				...
				<div className="relative  text-center text-2xl ">
					<div className="section1 relative w-full block mdl:flex ">
						...
						<div className="relative mdl:w-1/2  ">
							<Image src="/cryoInterior1.jpeg" layout="fill" alt="" />
						</div>
					</div>

					<div className="">
						<div className="section2 relative w-full block mdl:flex mb-20   ">
							<div className="relative mdl:w-1/2  mdl:opacity-50 bg-[] ">
								<Image src="/relax.jpg" layout="fill" alt="" />
							</div>
