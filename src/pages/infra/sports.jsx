...
function sports() {
	return (
		<AnimatedPage>
			<div className=" bg-blue1 pb-20   font-taviraj">
				<SEO
				...
				<h2 className="w-[90vw] md:w-[80vw] mdl:w-[50vw] flex text-2xl  text-center text-blue font-bold shadow-md shadow-blue mx-auto px-5 py-5 mb-20 ">
				...
				<div className="ml-5">
					...
					<p>
						Il s’interroge en permanence sur l’intérêt des efforts
						qu’il demande et cherche des formes de plus en plus
						efficaces qui présentent le meilleur rapport
						efforts/résultats.
					</p>
				...
				{/* ************************************* */}
				<div className="ml-5">
					<h3 className="w-[80vw] md:w-[45vw] mx-auto py-5 text-center text-xl text-skyblue shadow-button mt-10 mb-5 ">
					...
					<div>
						<p className="text-center text-blue">
							Avant les entraînements, une séance de 20 mn à 60°C
							permet de diminuer le temps nécessaire à l’échauffement
						</p>
						<p className="text-center text-blue">
							La veille de chaque compétition importante, la
							préparation des athlètes se fait avec une séance de 45
							mn de VITAL DOME, à 75°C (de préférence en soirée, avant
							ou après le dîner)
						</p>
						<p className="text-center text-blue">
				...
				<div className="ml-5">
					<p>
						Au repos, les muscles et les tendons sont à une
						température de 36°C. Or il a été observé que leur
						rendement maximal se situe à une température de 39°C. A
						cette température, les tendons sont plus élastiques et la
						souplesse musculaire beaucoup plus grande (80% de gain
						selon certaines sources). La force musculaire augmente
						également avec la température (2% par degré, R.Close
						1972).
					</p>
					<p className="text-center text-blue">
					...
					<p>
						...
						performances dans les premières minutes de reprise. Mohr
						et al. (2004)
					</p>
					<p className="text-center text-blue">
						Pour limiter la baisse de performance, les séances de
						VITAL DOME sont une solution permettant d’y parvenir en
						minimisant les impacts sur les joueurs.
					</p>
				</div>

				{/* ************************************** */}
				<h3 className="w-[80vw] md:w-[45vw] mx-auto  py-5 text-center text-xl text-skyblue shadow-button mt-20 mb-5 ">
					La récupération physique
				</h3>
				<div className="ml-5">
					<p>
						Les séances de VITAL DOME sont très utiles après les
						efforts consentis lors de phases de travail importantes.
					</p>
					<p>
						Réduction des douleurs musculaires : très bonnes
						sensations d’amélioration des douleurs et contractures
						musculaires.
					</p>
					<p>
					...
					<p className="text-center text-blue">
						Nous estimons que des séances de 40 mn à 70°C de VITAL
						DOME accélèrent le processus de récupération et font
						gagner, selon les organismes des athlètes, entre 25 et 35%
						de temps dans la récupération.
					</p>
					<p className="bg-blue2 w-[90vw] md:w-[70vw] border-2 border-blue rounded-md mx-auto mt-5 py-3 px-5">
						...
						processus de récupération peuvent être dirigés et
						accélérés naturellement mais aussi à l&apos;aide de moyens
						de stimulation artificiels.
					</p>
				...
				<div className="ml-5">
					...
					<p className="bg-blue2 w-[90vw] md:w-[70vw] border-2 border-blue rounded-md mx-auto mt-5 py-3 px-5">
						...
						l’entraînement, peuvent conduire les athlètes à ressentir
						et exprimer une «fatigue psychologique» se manifestant par
						une moindre adhésion aux objectifs de l&apos;entraînement,
						des troubles comportementaux et de l’humeur, des
				...
				<div className="ml-5">
					<p>
						...
						nerveux parasympathique, permettent une détente profonde
						et une réelle relaxation avec comme bénéfices une
						meilleure qualité de sommeil et une meilleure récupération
						après les longs déplacements.
					</p>
					<p className="text-center text-blue">
					...
					<p className="bg-blue2 w-[90vw] md:w-[70vw] border-2 border-blue rounded-md mx-auto mt-5 py-3 px-5">
						...
						chargés. Il en résulte que les athlètes sont sollicités
						tout au long de l&apos;année sans périodes bien
						identifiées de repos.
						<br />
				...
				<div className="ml-5">
					<p>
						Il s’agit d’un événement traumatisant créant un
						déséquilibre majeur dans la vie des sujets et engendrant
						des processus défensifs semblables à ceux définis dans un
						travail de deuil. Ils révèlent le caractère ambivalent de
						la blessure qui apporte à la fois des pertes et des
						pénalités, des gains et des bénéfices ; elle met hors jeu
						mais permet aussi, par un remaniement dans l’après coup,
						une remise en jeu ; elle devient parfois même source de
						progrès.
					</p>
					<p className="text-center text-blue mb-20">
						Le VITAL DOME prend sa place dans une «stratégie
						préventive» de la blessure car au delà de la préparation
						et de la protection de l’organisme, les séances de VITAL
						DOME vont aider les athlètes à mieux cicatriser et
						récupérer plus vite de leurs traumatismes.
					</p>
				</div>
			</div>
		</AnimatedPage>
