...
function sports() {
	return (
		<div className=" bg-blue1   font-taviraj animate__animated animate__fadeIn animate__slow">
			<Head>
				<title>L&apos;infrathérapie pour les sportifs</title>
			...
			<Layout>
				...
				<div className="ml-5">
					...
					<div className="relative w-[90vw] mdl:w-[40vw] h-[30vh] md:h-[40vh] mdl:h-[50vh] mx-auto mb-20 shadow-lg shadow-skyblue">
						<Image
				...
				<div className="ml-5">
					...
					<div className=" relative w-[90vw] mdl:w-[60vw] h-[40vh] mdl:h-[60vh]  mx-auto mt-10 border-2 border-skyblue">
						<Image
