	...
	return (
		<AnimatedPage>
			<div className=" bg-blue1 min-h-screen w-screen pb-20 font-taviraj">
				...
				<div className="">
					<h2 className="mb-5 font-bold text-blue text-3xl mdl:text-4xl text-center">
						Les bienfaits{" "}
					</h2>
					<br />
				</div>
				...
				{/* SECTION 1 */}
				<h3 className=" relative underline  text-skyblue text-2xl font-bold text-center xs:bg-blue xs:h-20 md:bg-[transparent] xs:py-5 ">
