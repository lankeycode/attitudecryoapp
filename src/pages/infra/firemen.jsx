...
function firmen() {
	return (
		<div className="min-h-screen  bg-blue1 font-taviraj animate__animated animate__fadeIn animate__slow">
			<Head>
				<title>Les pompiers de NY</title>
			...
			<Layout>
				...
				<br />
				<div className="relative md:w-[70vw] mdl:w-[45vw] h-[45vh] mx-auto xs:mb-10 md:mb-20">
					<Image
						src={"/fireman1.png"}
						layout="fill"
						alt=""
				...
				<div className="ml-5">
					<p>
						...
						radionucléaires, dioxines, benzène, PCB, plastiques
						divers, silicone, etc…) et comment nombre d’entre eux ont
						pu s’en sortir grâce à la détoxication au sauna
						infrarouge.
					</p>
					<br />
					<p>
						...
						d’augmenter leur élimination tout en restaurant
						l’équilibre métabolique, est très documentée. Le protocole
						est depuis longtemps établi comme sûr (Schnare DW , Denk
						G, Shields M, Brunton S, Evaluation of a detoxification
						regimen for fat stored xenobiotics.Med
					...
					<p>
						...
						amélioration symptomatique simultanée (Schnare, DW, Ben,
						M, and Shields, MG, Body Burden Reduction of PCBs , PBBs
						and Chlorinated Pesticides in Human Subject. Ambio. 1984 ;
