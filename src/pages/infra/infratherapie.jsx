		...
		<div className=" bg-blue1 font-taviraj animate__animated animate__fadeIn animate__slow">
			...
			<Layout>
					...
					<div className="section1 relative w-full block mdl:flex mb-16 ">
						<div className="realtive text-lg md:text-xl mdl:w-1/2 w-[100vw] text-justify pt-10 px-5 mdl:px-20 bg-blue2">
							...
							<p className="mb-5">
								...
								rayonnement infrarouge transmet de la chaleur à la
								peau sans contact et sans bouleverser sa régulation
								thermique.
							</p>
							<p className="mb-5">
								Ce sont les finlandais qui ont popularisé
								l’utilisation du sauna. Leurs ancêtres les utilisaient
								lors de leur cérémonie religieuse pour leur bien-être
								mental, spirituel et physique. Ils y sont restés
								fidèle lorsqu’ils se sont déplacés entre 5.000 et
								3.000 AV. J-C du nord- ouest du Tibet à leur nouvel
								emplacement en Finlande. Les indiens d’Amérique qui
								utilisaient des petites huttes aménagées pour se
								nettoyer et se purifier, reconnaissaient les effets
								bénéfiques sur la santé du processus de transpiration.
							</p>
							<p>
							...
							<p>
								...
								l’utilisation des ondes infrarouge en thérapie, a
								servi pour les prématurés en incubateur et les lampes
								infrarouges servant à aider la cicatrisation des
								tissus endommagés.{" "}
							</p>

							<p className="mb-5">
								L’infrathérapie est une méthode de soin douce,
								naturelle et sans danger, utilisant les infrarouges
								longs. Le réchauffement se produit au cœur du tissu
								musculaire. Cela provoque une sudation importante
								identique à celle générée lors d’un effort physique
								soutenu.
							</p>
							<p className="mb-5">
						...
						<div className="relative mdl:w-1/2  mdl:opacity-50">
							<Image src="/leDome.jpg" layout="fill" alt="" />
						</div>
					</div>
				</div>
				<div className=" text-lg md:text-xl">
					...
					<br />
					<p>
						Cette technique représente une véritable révolution pour
						la désintoxication du corps humain quotidiennement agressé
						par des milliers d’agents polluants.
					</p>
					<br />
					<p>L’infrathérapie est accessible à tous !</p>
					<p>
						Et, vraiment adapté à tous, aux sportifs, aux hyperactifs,
						aux stressés, et aux gourmands. Un vrai moment de
						bien-être aux multiples bienfaits pour vous aider au
						quotidien.
					</p>
					<br />
					<p>
				...
				<div>
					<p className="text-blue font-bold mt-20">
						Contre indication
					</p>
					<br />
