	...
	return (
		...
		>
			<SEO
				...
				description="Attitude Cryo accompagne les entreprises sur le sujet de QVCT « Qualité de Vie et des Conditions de Travail » à travers le levier de bien-être. Attitude Cryo, un centre pour tous,même pour les entreprises. Dans le milieu professionel, on assiste à une prise de conscience des bienfaits de la pratique d'activité physique et sportive pour la santé et le bien-être au travail."
			/>
			...
			<div className="px-3">
				...
				<p>
					...
					bureau en restant statique, mais effectuant en permanence le
					même geste (bouger la souris) attrapent une tendinite au
					poignet, et que des ouvriers de chantier soumis à
				...
				<p>
					...
					des Troubles Musculo-Squelettiques, en particulier la
					pratique d’une activité physique et sportive (APS) et/ou une
					activité de bien-être. Toutes les entreprises qui proposent
					ces activités sportives et/ou bien-être à la disposition de
					leurs collaborateurs y trouvent des bénéfices directs :
				</p>
				<p>
					Chez Veolia, la productivité des salariés s’est améliorée de
					6 à 9 % et le taux d’absentéisme a diminué de 30 %.
				</p>
				<p>
					Safran, sur son site de Colomiers près de Toulouse, a réussi
					à réduire de 50 % l’absentéisme de ses ouvriers grâce au
					sport. Avantage supplémentaire : parmi les fumeurs, 60 % ont
					arrêté la cigarette.
				</p>
				<p className="mb-20">
